...
export default {
  ...
  ignoreIssues: {
    ...
    // Activity seam of openspec/changes/alert-activity-condition (poller 4.3 wiring pending).
    'src/deferred-prompts/{condition-eval,alerts,poller-alerts-activity}.ts': ['exports'],
