...
/** Factory function for creating KonturTalkChatProvider instances from instance config. */
export const createProvider = (id: string, config: Record<string, string>): ChatProvider =>
  new KonturTalkChatProvider({ jwtToken: config['jwtToken'], platformInstanceId: id })
