...
| `src/analytics/`                                   | Privacy-gated analytics: fact contracts, normalizer/runtime, instrumentation, session/outcome/friction materialization, governed usage backfill/reconciliation |
