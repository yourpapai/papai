...
export const scenarios = {
  ...
  'settings-admin-feature-flags-populated': [...adminFeatureFlagsHandlers.populated],
  'settings-admin-feature-flags-empty': [...adminFeatureFlagsHandlers.empty],
  'settings-admin-feature-flags-error': [...adminFeatureFlagsHandlers.error],
  'settings-admin-feature-flags-loading': [...adminFeatureFlagsHandlers.loading],
  ...
  'settings-shell-admin-ready': [
    ...
    ...adminFeatureFlagsHandlers.populated,
