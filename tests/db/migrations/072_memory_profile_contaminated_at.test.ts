...
import { migration072MemoryProfileContaminatedAt } from '../../../src/db/migrations/072_memory_profile_contaminated_at.js'
...
describe('migration 072: memory_profiles.contaminated_at', () => {
  ...
  test('migration id is 072_memory_profile_contaminated_at', () => {
    expect(migration072MemoryProfileContaminatedAt.id).toBe('072_memory_profile_contaminated_at')
  })
