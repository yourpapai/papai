...
import { migration068IdentityScopedKeyCleanup } from '../../../src/db/migrations/068_identity_scoped_key_cleanup.js'
...
describe('migration 067', () => {
  test('has correct id', () => {
    expect(migration068IdentityScopedKeyCleanup.id).toBe('068_identity_scoped_key_cleanup')
  })
  ...
  test('removes orphaned scoped-key rows and keeps raw platform user id rows', () => {
    ...
    migration068IdentityScopedKeyCleanup.up(db)
