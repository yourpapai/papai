...
const LOCAL_SCENARIO_NAMES = [
  ...
  'settings-llm-model-metadata-models-dev',
  'settings-llm-model-metadata-prefix-table',
  'settings-llm-model-metadata-no-limits',
  'settings-llm-model-metadata-catalogue-unavailable',
