...
describe('hermetic story runner', () => {
  ...
  test.each([
    ...
    ['rejects a tsgo-shaped executable outside the execution root', 'Bun.spawn'],
    ['rejects a tsgo-shaped child_process spawn outside the execution root', 'child_process.spawn'],
