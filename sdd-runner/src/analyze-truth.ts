...
/**
 * Ground-truth join (D1 leg 3): for each analyzed run's change folder — tasks
 ...
 * unmerged) and merged-unimplemented (merged, zero tasks done) changes. All
 * git access goes through the read-only `log`/`ls-tree` seam.
 */
