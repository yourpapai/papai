...
const log = logger.child({ scope: 'migration:075' })
...
const up = (db: Database): void => {
  ...
  `)
  log.info('migration 075: memory_recall_shadow_log table created')
}

export const migration075MemoryRecallShadowLog: Migration = {
  id: '075_memory_recall_shadow_log',
  up,
}

export default migration075MemoryRecallShadowLog
