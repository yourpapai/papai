...
const log = logger.child({ scope: 'migration:050' })
...
const up = (db: Database): void => {
  ...
  log.info('migration 050: settings auth tables created')
}

export const migration050SettingsAuth: Migration = {
  id: '050_settings_auth',
  up,
}

export default migration050SettingsAuth
