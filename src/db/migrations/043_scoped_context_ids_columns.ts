...
export const CONTEXT_OWNED_COLUMNS: readonly ContextOwnedColumn[] = [
  ...
  { table: 'group_admin_observations', column: 'context_id', conflictColumns: ['provider', 'user_id'], threadScoped: false },
  { table: 'group_user_observations', column: 'context_id', conflictColumns: ['provider', 'user_id'], threadScoped: false },
