 ...
 * per-leaf filtering happens client-side at evaluation). No `start` anchor
 * is passed (design D4): windowing semantics vary across providers and the
 * full-refetch cost is accepted, so filtering stays client-side. */
