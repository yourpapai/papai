...
/**
 * Runtime `intent.v1` taxonomy. Frozen against the PoC module
 * `docs/research/analytics-metrics/poc/intent/taxonomy.ts`; label strings,
 * ids, and sort order must never drift (a drift creates `intent.v2`).
 */
