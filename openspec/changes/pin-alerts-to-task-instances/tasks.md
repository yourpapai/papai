...
- [x] 6.3 Update affected docs (`docs/architecture/behaviors.md` alert/task-instance sections, `docs/architecture/tools.md` if alert tool behavior is described) to document pinning, NULL-pin semantics, and the cancel paths. Verify: docs render and match shipped behavior
