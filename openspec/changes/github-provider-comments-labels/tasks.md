...
- [x] 6.2 Implement the methods on `plugins/task-provider-github/provider.ts`, delegating to the operations modules with the resolver from 4.2, until the suite passes — verify with `bun test tests/plugins/task-provider-github/provider.test.ts`
