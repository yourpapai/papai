...
- [x] 4.2 Full gates: `bun run test`, `bun run typecheck`, `bun run lint` — all green; `openspec validate --strict` green; every tasks.md box checked. Verify: `bun run test:status`
