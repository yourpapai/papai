...
- [ ] 2.1 Add a failing case to the `mapTaskListItem` block in `tests/plugins/task-provider-kaneo/mappers.test.ts` asserting `createdAt` is preserved. Verification: `bun test tests/plugins/task-provider-kaneo/mappers.test.ts` (red).
