...
- [x] 4.4 Update affected docs — sweep `docs/architecture/*.md` (behaviors.md live-status entry, commands.md `/context` notes) for any now-stale "English-only" claims about these two surfaces; record the localization there: `git status --short docs/`
