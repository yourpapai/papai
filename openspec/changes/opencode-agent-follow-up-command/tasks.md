...
- [x] 5.2 `opencode-agent/CLAUDE.md`: note the surface exception as the one carve-out in `commandSurface` and the side-operation dispatch — verify with `bun run lint`
