...
- [x] 5.3 Final gates over the whole tree: `bun run test`, `bun run typecheck`, `bun run lint` — all green (query a red run with `bun run test:failures` before re-running anything)
