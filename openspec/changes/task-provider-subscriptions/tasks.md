...
- [x] 3.8 Final sweep: confirm the affected `docs/architecture/` pages (tasks 2.1–2.4) are updated and every check in 3.3–3.7 is green. Verify: `openspec validate task-provider-subscriptions --strict`
