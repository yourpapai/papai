...
Defines the deterministic operator-facing outputs of a run: report content and its PR variant, gains accounting sourced from auto_decision events, and run summaries.
