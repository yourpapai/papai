# lint-default-parity Specification

## Purpose

Keeps every workspace under the repository's shared oxlint configuration at full default severity: no path-scoped rule relaxations survive a prototype window, and afk-runner sources and tests prove their types without assertion witnesses or unvalidated artifact reads.
