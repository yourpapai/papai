...
- **mutation:** Lane-aware coverage-map spawns client tests, skips e2e/stories
- **review-loop:** Drain agent log writes in dispose (CI ENOENT flake)
- **deploy:** Ship operator scripts in the prod image for runbook CLIs
## [6.12.0] - 2026-07-31
